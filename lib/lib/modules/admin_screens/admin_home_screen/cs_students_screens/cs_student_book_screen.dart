...
import 'cs_student_book_pdf_screen.dart';
import 'cs_student_details_screen.dart';

class CsStudentBookScreen extends StatefulWidget {
  const CsStudentBookScreen({Key? key, required this.CsStudentBooksId}) : super(key: key);
  final int CsStudentBooksId;

  @override
  State<CsStudentBookScreen> createState() => _CsStudentBookScreenState();
}
                                  ...
                                  builder: (context, state) {
                                    return Scaffold(
                                      floatingActionButton: IconButton(icon:Icon(Icons.arrow_back_ios)
                                        ,onPressed: ()
                                        {
                                          navigateAndEnd(context, CsStudentDetailsScreen(StudentId: widget.CsStudentBooksId));
                                        },
                                      ),
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: PageView.builder(
                                ...
                                itemCount: cubit.csStudentsModel![widget.CsStudentBooksId].books!.length,
                                          ...
                                          child: InkWell(
                                            child: Column(
                                              children: [
                                                Image(
                                                    ...
                                                    image: NetworkImage(
                                                        AppCubit.get(context).csStudentsModel![widget.CsStudentBooksId].books![index].cover!
                                                    )),
                                                SizedBox(height: size.height * 0.01),
                                                Expanded(
                                                  child: Text(
                                                    AppCubit.get(context).csStudentsModel![widget.CsStudentBooksId].books![index].name!,
                                                    maxLines: 1,
                                                    overflow: TextOverflow.ellipsis,
                                                    style: TextStyle(
                                                      fontSize: 16.0,
                                                ...
                                                Expanded(
                                                  child: Text(
                                                    AppCubit.get(context).csStudentsModel![widget.CsStudentBooksId].books![index].description!,
                                                    maxLines: 1,
                                                    overflow: TextOverflow.ellipsis,
                                                    style: TextStyle(
                                                      fontSize: 16.0,
                                            ...
                                            onTap: ()
                                            {
                                              navigateTo(context, CsStudentBookPDFScreen(
                                                CsStudentBookId: index,
                                                CsStudentID: widget.CsStudentBooksId,
                                              ),
                                              );
                                            },
                                          )
