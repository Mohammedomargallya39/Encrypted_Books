...
class CSStudentAccessBookScreen extends StatefulWidget {
  const CSStudentAccessBookScreen({Key? key,required this.CsAccessIndexBookId}) : super(key: key);
  final dynamic CsAccessIndexBookId;

  @override
  State<CSStudentAccessBookScreen> createState() => _CSStudentAccessBookScreenState();
}

class _CSStudentAccessBookScreenState extends State<CSStudentAccessBookScreen> {
  void initState() {
              ...
              child: Stack(
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: SvgPicture.asset('assets/images/cs.svg',
                                      ...
                                      [
                                        Container(
                                          ...
                                          decoration:   BoxDecoration(shape: BoxShape.circle,
                                            ...
                                            NetworkImage(AppCubit.get(context).csStudentsModel![index].image!),
                                                fit: BoxFit.fill
                                            ),
                                          ),
                                        ),
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children:  <Widget>
                                            [
                                              Text(AppCubit.get(context).csStudentsModel![index].name! ,
                                                maxLines: 1,
                                              ...
                                              Text(AppCubit.get(context).csStudentsModel![index].email!.split('@').first ,
                                                maxLines: 1,
                                                overflow: TextOverflow.ellipsis,
                                                style: TextStyle(
                                                  fontWeight: FontWeight.bold ,
