...
class EngStudentDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
            AppCubit.get(context).engStudentsModel![EngStudentId].name!
        ),
      ),
            ...
            [
                  ...
                  child: GestureDetector(
                    child: Container(
                      ...
                      decoration:  BoxDecoration(shape: BoxShape.circle,
                        ...
                        NetworkImage(
                            AppCubit.get(context).engStudentsModel![EngStudentId].image!
                        ),
                            fit: BoxFit.fill
                        ),
                      ),
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      AppCubit.get(context).engStudentsModel![EngStudentId].email!.split('@').first
                      ,
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                      style: TextStyle(
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      '${AppCubit.get(context).engStudentsModel![EngStudentId].numberofBooks}'
                      ,
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                      style: TextStyle(
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      '${AppCubit.get(context).engStudentsModel![EngStudentId].createdAt!.split('T').first}'
                      ,
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                      style: TextStyle(
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      '${AppCubit.get(context).engStudentsModel![EngStudentId].updatedAt!.split('T').first}'
                      ,
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                      style: TextStyle(
              ...
              Padding(
                ...
                child: defaultButton(
                  function: ()
                  {
                    debugPrint('${AppCubit.get(context).engStudentsModel![EngStudentId].books!.length}');
              ...
              Center(
                child: defaultTextButton(
                    onPressed: ()
                    {
                      AppCubit.get(context).indexStudent= EngStudentId;
                        showDialog(
                            context: context,
                            builder: (context) =>
