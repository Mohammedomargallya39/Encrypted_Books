...
class EngStudentsScreen extends StatelessWidget {
  const EngStudentsScreen({Key? key}) : super(key: key);
            ...
            body: ListView.separated(
                ...
                itemBuilder:  (context,index) {
                 // AppCubit.get(context).indexStudent= index;
                  return InkWell(
                    child: engStudentsItem(StudentsModel(
                      name: AppCubit.get(context).engStudentsModel![index].name,
                      email: AppCubit.get(context).engStudentsModel![index].email!.split('@').first,
                      image: AppCubit.get(context).engStudentsModel![index].image,
                      sId: AppCubit.get(context).engStudentsModel![index].sId,

                    ) , context),
                    onTap: ()
                    {
                      navigateTo(context, EngStudentDetailsScreen(
                        EngStudentId: index,
                      ),
                      );
                    },
  ...
  Widget engStudentsItem(StudentsModel studentsModel , context)
  {
