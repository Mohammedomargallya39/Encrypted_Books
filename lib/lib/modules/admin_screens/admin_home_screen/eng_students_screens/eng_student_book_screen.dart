...
class EngStudentBookScreen extends StatelessWidget {
      ...
      BlocConsumer<AppCubit,AppStates>(
        ...
        builder: (context, state)
        {
          ...
          return ConditionalBuilder(
            condition: cubit.engStudentsModel![EngstudentBooksId].books != null,
            builder: (context) =>  Scaffold(
                                  ...
                                  onTap: ()
                                  {
                                    navigateTo(context,
                                        EngBooksCanAddedForStudentPdfScreen(
                                          ...
                                          EngStudentIndexId: EngstudentBooksId,
                                        )
                                    )
                                    ;
                                  },
              ...
              body: ListView.separated(
                  ...
                  itemBuilder: (context,index) => InkWell(child:engStudentBooks(
                    ...
                    onTap: ()
                    {
                      navigateTo(context, EngStudentBookPDFScreen(
                        EngStudentID: EngstudentBooksId,
                  ...
                  itemCount: cubit.engStudentsModel![EngstudentBooksId].books!.length),
            ),
